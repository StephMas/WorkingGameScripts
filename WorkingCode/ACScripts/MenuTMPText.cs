 ...
 *	Element added by Stephanie Maslen 2018
 *	
 *	"MenuTMPText.cs"
 * 
 *	This MenuElement provides a category for using Text Mesh Pro text as a label directly from the Menu Manager system. Requires TextMeshPro to work.
 * 
 */
...
namespace AC
{
    ...
    /**
	 * A MenuElement that provides a category for using Text Mesh Pro text as a label directly from the Menu Manager system. Requires TextMeshPro to work.
	 ...
	 */
    public class MenuTMPText : MenuElement
    {
        ...
        {
            uiTMP = LinkUIElement<TextMeshProUGUI>(canvas);
        }
        ...
        public override void ShowGUI(Menu menu)
        {
            ...
            {
                uiTMP = LinkedUiGUI<TextMeshProUGUI>(uiTMP, "Linked Text:", source);
        ...
        public override void PreDisplay(int _slot, int languageNumber, bool isActive)
        {
            ...
            if (uiTMP != null && Application.isPlaying)
            {
                uiTMP.text = newLabel;
                UpdateUIElement(uiTMP);
            }
        }
