...
namespace AC
{
	...
	public class MenuManager : ScriptableObject
	{
		...
		private string[] elementTypes = { "Button", "Crafting", "Cycle", "DialogList", "Drag", "Graphic", "Input", "Interaction", "InventoryBox", "Journal", "Label", "TMPText", "ProfilesList", "SavesList", "Slider", "Timer", "Toggle" };
